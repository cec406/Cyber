#!/usr/bin/env python3
"""
Grizzly Tomcat Breaker
Lightweight Tomcat /manager/html credential scanner for authorized lab/pen-testing use only.
Built by Grizzly System Engineering – East Helena, Montana
https://grizzlyse.com | (406) 439-8127 | info@grizzlyse.com

WARNING: This tool is STRICTLY for authorized penetration testing on systems you OWN or have EXPLICIT WRITTEN PERMISSION to test.
Unauthorized use is illegal. Use only in controlled lab environments or with client approval.
"""
import subprocess
import argparse
import os
